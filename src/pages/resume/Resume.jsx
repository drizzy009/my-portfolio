...
import { FaReact, FaCss3Alt, FaHtml5, FaWordpress, FaAws } from "react-icons/fa";
            ...
            <div className={`${styles.resume_row_one}`}>
              <div className={`${styles.resume_content}`}>
                <ul>
                  ...
                  <li>
                    Managed multi-environment deployments for staging, testing, and live instances of UBA Nigeria & UBA Group websites.
                  </li>
                  <li>
                  ...
                  <li>
                    Built a full event verification system with scan limits per user, analytics, Cloudinary QR storage, and updating scanned users to Google Sheet in Real Time.
                  </li>
                  <li>
                  ...
                  <li>Resolved browser push notification issues for clients including Wakanow, Altbank, and
                    UBA using Netcore Cloud platform</li>
                  <li>Troubleshot technical issues related to website performance, API connections, and
                  ...
                  <li>Built a mini Google Maps web app with time-based branch/ATM open status filters.</li>
                </ul>
              </div>
            </div>
          </div>
